            ...
            <section className="footer-style1 at-home6 home2-footer-radius pt25 pb-0">
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-6 col-lg-3">
                            <div className="link-style1 mb-4 mb-sm-5">
                                <h5 className="mb15 text-white">Categories</h5>
                                <ul className="ps-0">
                                    {category.map((item, i) => (
                                        <li key={i}>
                                            <Link href={item.path}>
                        ...
                        <div className="col-sm-6 col-lg-3">
                            <div className="link-style1 mb-4 mb-sm-5">
                                <h5 className="mb15 text-white">Support</h5>
                                <ul className="ps-0">
                                    {support.map((item, i) => (
                                        <li key={i}>
                                            <Link href={item.path}>
                    ...
                    <div className="row align-items-center">
                        <div className="col-md-6">
                            <div className="text-center text-lg-start">
                                <p className="copyright-text mb-0 text-white-light ff-heading">
                                    © {process.env.PROJECT_NAME}. {new Date().getFullYear()}
                                    <Link
                                        href="/"
                                        target="_blank"
                                        style={{ color: "inherit" }}
